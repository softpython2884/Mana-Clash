...
export const allCards: Omit<Card, 'tapped' | 'isAttacking' | 'canAttack' | 'summoningSickness'>[] = [
  ...
  createCard('human_soldier', 'Soldat Humain', 'Creature', 2, "Entraîné et discipliné, un soldat fiable.", { attack: 2, health: 2, armor: 1, rarity: 'Common', preferredBiome: 'Plains', element: 'Neutral' }),
  ...
  createCard('guard_dog', 'Chien de Garde', 'Creature', 2, "Loyal et protecteur.", { attack: 2, health: 3, armor: 0, rarity: 'Common', preferredBiome: 'Plains', element: 'Neutral' }),
  createCard('giant_rat', 'Rat Géant', 'Creature', 1, "Un nuisible plus gros et plus agressif que la normale.", { attack: 2, health: 1, armor: 0, rarity: 'Common', preferredBiome: 'Ruins', element: 'Shadow' }),
  createCard('fragile_skeleton', 'Squelette Fragile', 'Creature', 1, "Se brise facilement, mais continue de se battre.", { attack: 1, health: 1, armor: 0, rarity: 'Common', preferredBiome: 'Ruins', element: 'Shadow' }),
  createCard('minor_spirit', 'Esprit Mineur', 'Creature', 1, "Une faible entité ectoplasmique.", { attack: 1, health: 2, armor: 0, rarity: 'Common', preferredBiome: 'Ruins', element: 'Shadow' }),
  createCard('brave_peasant', 'Paysan Courageux', 'Creature', 1, "N'a pas grand-chose, mais défend sa terre.", { attack: 1, health: 1, armor: 0, rarity: 'Common', preferredBiome: 'Plains', element: 'Neutral' }),
  createCard('wandering_monk', 'Moine Errant', 'Creature', 2, "Un combattant ascétique et discipliné.", { attack: 2, health: 2, armor: 1, rarity: 'Common', preferredBiome: 'Sanctuary', element: 'Light' }),
  createCard('cave_bat', 'Chauve-Souris des Cavernes', 'Creature', 1, "Rapide et difficile à attraper.", { attack: 1, health: 1, armor: 0, rarity: 'Common', preferredBiome: 'Cavern', element: 'Air' }),
  ...
  createCard('black_raven', 'Corbeau Noir', 'Creature', 1, "Un sombre présage qui vole dans le ciel.", { attack: 1, health: 1, armor: 0, rarity: 'Common', preferredBiome: 'Sky', element: 'Air' }),
  ...
  createCard('sage', 'Sage Oublié', 'Creature', 3, 'Compétence: Piochez une carte.', { attack: 2, health: 2, armor: 0, preferredBiome: 'Sanctuary', skill: { type: 'draw', used: false, cooldown: 4 }, rarity: 'Rare', element: 'Neutral' }),
  ...
  createCard('elemental_water', 'Élémentaire d\'Eau', 'Creature', 3, "Vague déferlante.", { attack: 2, health: 4, armor: 1, criticalHitChance: 5, preferredBiome: 'River', rarity: 'Rare', element: 'Water' }),
  createCard('elemental_earth', 'Élémentaire de Terre', 'Creature', 3, "Mur de pierre vivant.", { attack: 1, health: 5, armor: 2, criticalHitChance: 0, preferredBiome: 'Cavern', rarity: 'Rare', element: 'Earth' }),
  createCard('fallen_shaman', 'Chaman Déchu', 'Creature', 2, "Compétence: Sacrifiez cette créature pour soigner un allié de 75% de ses PV restants.", { attack: 1, health: 3, armor: 0, preferredBiome: 'Void', skill: { type: 'sacrifice', target: 'friendly_creature', used: false, cooldown: 0 }, rarity: 'Rare', element: 'Shadow' }),
  createCard('knowledge_priest', 'Prêtre du Savoir', 'Creature', 2, 'Compétence: Piochez une carte.', { attack: 1, health: 2, armor: 0, preferredBiome: 'Sanctuary', skill: { type: 'draw', used: false, cooldown: 3 }, rarity: 'Rare', element: 'Neutral' }),
  createCard('shadow_assassin', 'Assassin des Ombres', 'Creature', 4, "Attaque depuis l'ombre avec une précision mortelle.", { attack: 5, health: 2, armor: 0, criticalHitChance: 25, preferredBiome: 'Ruins', rarity: 'Rare', element: 'Shadow' }),
  ...
  createCard('griffon', 'Griffon Majestueux', 'Creature', 5, "Une bête ailée rapide et puissante.", { attack: 4, health: 4, armor: 2, criticalHitChance: 15, preferredBiome: 'Sky', rarity: 'Epic', element: 'Air' }),
  createCard('minotaur', 'Minotaure Enragé', 'Creature', 6, "Charge furieusement ses ennemis.", { attack: 6, health: 5, armor: 3, criticalHitChance: 25, preferredBiome: 'Ruins', rarity: 'Epic', element: 'Earth' }),
  createCard('ruin_specter', 'Spectre des Ruines', 'Creature', 5, "Hante les lieux oubliés, aspirant la vie.", { attack: 5, health: 4, armor: 1, preferredBiome: 'Void', rarity: 'Epic', element: 'Shadow' }),
  createCard('ancestral_basilisk', 'Basilic Ancestral', 'Creature', 7, "Son regard pétrifie les plus courageux.", { attack: 5, health: 7, armor: 5, preferredBiome: 'Cavern', rarity: 'Epic', element: 'Earth' }),
  ...
  createCard('archmage_elements', 'Archimage des Éléments', 'Creature', 9, "Maîtrise absolue sur le feu, l'eau et la terre.", { attack: 7, health: 7, armor: 4, preferredBiome: 'Sanctuary', rarity: 'Legendary', element: 'Neutral' }),
  createCard('abyss_lord', 'Seigneur des Abysses', 'Creature', 10, "Une puissance destructrice venue des profondeurs.", { attack: 10, health: 10, armor: 5, preferredBiome: 'Void', rarity: 'Legendary', element: 'Shadow' }),

  // Special Summon Creatures (Combos)
  createCard('berlin_wall', 'Mur de Berlin', 'SpecialSummon', 0, "Provocation. Solide comme le roc, mais en béton.", { attack: 2, health: 15, armor: 8, taunt: true, rarity: 'Epic', element: 'Neutral', preferredBiome: 'Ruins' }),
  createCard('china_wall', 'Muraille de Chine', 'SpecialSummon', 0, "Provocation. Visible depuis l'espace, infranchissable sur terre.", { attack: 4, health: 30, armor: 10, taunt: true, rarity: 'Legendary', element: 'Neutral', preferredBiome: 'Plains' }),
  createCard('iron_colossus', 'Colosse de Fer', 'SpecialSummon', 0, "Fusion de Golem et Minotaure. Une force inarrêtable.", { attack: 8, health: 12, armor: 6, taunt: true, rarity: 'Legendary', element: 'Earth', preferredBiome: 'Mountain' }),
  createCard('ancient_dragon', 'Dragon Ancien', 'SpecialSummon', 0, "Fusion de Dragon et Phénix. La renaissance du feu.", { attack: 9, health: 9, armor: 5, criticalHitChance: 25, rarity: 'Legendary', element: 'Fire', preferredBiome: 'Volcano' }),
  createCard('elemental_avatar', 'Avatar Élémentaire', 'SpecialSummon', 0, "Fusion des trois élémentaires. L'équilibre des puissances.", { attack: 7, health: 15, armor: 7, rarity: 'Legendary', element: 'Neutral', preferredBiome: 'Sanctuary' }),
  createCard('supreme_shadow', 'Ombre Suprême', 'SpecialSummon', 0, "Fusion de Vampire et Spectre. Maître de la non-vie.", { attack: 8, health: 8, armor: 3, skill: { type: 'lifesteal', used: false }, rarity: 'Legendary', element: 'Shadow', preferredBiome: 'Void' }),
  createCard('world_tree', 'Arbre-Monde', 'SpecialSummon', 0, "Fusion de Druide et Élémentaire de Terre. La vie incarnée.", { attack: 5, health: 20, armor: 10, rarity: 'Legendary', element: 'Earth', preferredBiome: 'Forest' }),
  createCard('judgment_angel', 'Ange du Jugement', 'SpecialSummon', 0, "Fusion de Clerc et Archimage. La justice divine.", { attack: 10, health: 10, armor: 8, skill: { type: 'heal', value: 5, target: 'player', used: false, cooldown: 3 }, rarity: 'Legendary', element: 'Light', preferredBiome: 'Sanctuary' }),
  createCard('stone_titan', 'Titan de Pierre', 'SpecialSummon', 0, "Fusion de Golem et Mur de Berlin. La défense absolue.", { attack: 6, health: 25, armor: 12, taunt: true, rarity: 'Legendary', element: 'Neutral', preferredBiome: 'Mountain' }),
  createCard('chimera', 'Chimère', 'SpecialSummon', 0, "Fusion de Griffon et Basilic. Une monstruosité parfaite.", { attack: 9, health: 11, armor: 6, criticalHitChance: 15, rarity: 'Legendary', element: 'Neutral', preferredBiome: 'Sky' }),
...
const createRandomDeck = (): Card[] => {
    ...
    let currentSize = Object.values(categoryCounts).reduce((a, b) => a + (b || 0), 0);
    
    const allCategories = Object.keys(deckRules.categories) as CardType[];

    while (currentSize < deckRules.deckSize) {
        const randomCategory = allCategories[getRandomInt(0, allCategories.length - 1)];
        if (categoryCounts[randomCategory]! < deckRules.categories[randomCategory as keyof typeof deckRules.categories].max) {
    ...
    while (currentSize > deckRules.deckSize) {
        const randomCategory = allCategories[getRandomInt(0, allCategories.length - 1)];
        if (categoryCounts[randomCategory]! > deckRules.categories[randomCategory as keyof typeof deckRules.categories].min) {
            categoryCounts[randomCategory]!--;
            currentSize--;
        }
    }
